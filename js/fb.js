...
$.getJSON("https://bucifan-api.azurewebsites.net/fbs/2019")
  .done(function(season){ 
      for(var i=0;i<season.games.length;i++){
          ...
          $("#gameitem"+i).append("<div class='gameitemleft'><span class='schdate'> "+season.games[i].GameDate+"</span></div>");
          $("#gameitem"+i).append("<div class='gameitemmid'><img src='/img/helmets/"+season.games[i].OppImage+"' /></div><div class='gameitemright'><span class='schteam'>"+season.games[i].Opp+"</span></div>");
          //if(i==11){
        //      for(var j=0;j<4;j++){ 
